...
`getLeaf()` can be tested without the script writing `merkleRoot.json` on
import.
...
leaves generated by LIGO, and runs as part of `npm --prefix infra run ci`. To
regenerate an expected value:
